...
const TechOrbitDisplay = memo(function TechOrbitDisplay({
  ...
  return (
    <section className='relative flex h-full w-full flex-col items-center justify-center overflow-hidden rounded-lg'>
      <span className='pointer-events-none whitespace-pre-wrap bg-gradient-to-b from-black to-green-300/80 bg-clip-text text-center text-7xl font-semibold leading-none text-transparent dark:from-white dark:to-slate-900/10'>
        {text}
      </span>
    ...
    <section className='max-md:w-full flex flex-col gap-4 w-96 mx-auto'>
      ...
      <form onSubmit={handleSubmit}>
        ...
        {textVariantButton && goTo && (
          <BoxReveal boxColor='var(--skeleton)' duration={0.3}>
            <section className='mt-4 text-center hover:cursor-pointer flex justify-center gap-4'>
              <button
...
const AuthTabs = memo(function AuthTabs({
  ...
  handleSubmit,
  additionalButton,
}: AuthTabsProps & { additionalButton?: React.ReactNode }) {
  return (
